...
| ---------------------- | -------------------------------- | ------------- | -------------------------------------------- |
| Local Todo — Issues    | `.storage/local_todo.issues.ics` | **Read-only** | Confirmed problems / broken behavior         |
...
| ------ | -------------------------------- | ------------------------------------------- |
| Issues | `.storage/local_todo.issues.ics` | Highest-priority HA backlog (bugs / breaks) |
